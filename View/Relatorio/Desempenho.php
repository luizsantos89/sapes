<?php
    ...
    if(isset($_REQUEST['ano'])) {
        $queryFuncionario = "select f.nome, d.nota, d.semestre, d.ano from desempenho AS d inner join funcionario AS f ON d.idFuncionario = f.idFuncionario WHERE ano = $ano AND semestre = $semestre";
    }
