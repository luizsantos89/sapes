...
<html lang="en">
  ...
  <body>
    ...
    <div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
        <h1 class="display-4">Absenteísmo:</h1><br />
      
    </div>
    <div class="container">
        <form action='../../Controler/controlerAbsenteismo.php?opcao=7' method='post'>
            <label>Selecione o período para <b>VISUALIZAR</b> as horas de absenteísmo correspondentes:</label><br />
            Mês: 
