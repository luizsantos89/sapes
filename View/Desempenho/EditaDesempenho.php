...
<html lang="en">
  ...
  <body>
    ...
    <div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
        <h1 class="display-4">Desempenho</h1><h3>Manutenção de Nota de Desempenho Individual</h3>
        <p class="lead">
            Editar nota:
        </p>
    </div>
    ...
    <div class="container">
      <div class="col-md-12 order-md-1">
          ...
          <form class="needs-validation" action="../../Controler/controlerDesempenho.php?opcao=3" method="post" novalidate>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-md-12 mb-3">
                        <label>Nota:</label>
                        <input type="text" class="form-control" name="nota" value="<?=$desempenho->nota;?>" required>
                    </div>
                </div>  
                <div class="row">
                    <div class="col-md-12 mb-3">
                ...
                <div class="row">
                    <div class="col-md-12 mb-3">
                        <label>Ano:</label>
                        <input type="text" class="form-control" name="ano" value="<?=$desempenho->ano?>" required>
                    </div>
                </div>              
                <input type="hidden" value="<?=$desempenho->idDesempenho;?>" name="idDesempenho" />
                <hr class="mb-6">
                <button class="btn btn-outline-primary" type="submit">Alterar dados</button>
                <a class="btn btn-outline-danger" href="../../Controler/controlerDesempenho.php?opcao=5=<?php echo $desempenho->idDesempenho;?>">Exclui</a>
